      ...
      <div style={{ padding: '1.25rem', marginBottom: '1rem', background: 'linear-gradient(135deg, #fff7eb 0%, #ffffff 70%)', border: '1px solid #f0e2cd', borderRadius: '18px', boxShadow: '0 14px 40px rgba(0,0,0,0.05)' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr auto', gap: '1rem', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8, alignItems: 'stretch' }}>
            <a  onClick={() => navigate("/Deposito")} style={{ display: 'inline-flex', justifyContent: 'center', alignItems: 'center', minWidth: 140, padding: '0.8rem 1rem', borderRadius: 12, background: '#111827', color: '#fff', textDecoration: 'none', fontWeight: 700 }}>Comprar VATs</a>
            <a  onClick={() => navigate("/Saque")} style={{ display: 'inline-flex', justifyContent: 'center', alignItems: 'center', minWidth: 140, padding: '0.8rem 1rem', borderRadius: 12, background: '#111827', color: '#fff', textDecoration: 'none', fontWeight: 700 }}>Saque</a>
